...
import com.mahmoudibrahem.firebaseplayground.util.Constants.CLOUD_MESSAGING_SCREEN_ROUTE
...
sealed class Destinations(val route: String) {
    ...
    object CloudMessaging:Destinations(route = CLOUD_MESSAGING_SCREEN_ROUTE)
}
